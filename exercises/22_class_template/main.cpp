...
struct Tensor4D {
    ...
    Tensor4D &operator+=(Tensor4D const &others) {
        ...
        for(unsigned int i3 = 0; i3 < shape[3]; i3++){
            unsigned int idx = i0 * shape[1] * shape[2] * shape[3] + i1 * shape[2] * shape[3] + i2 * shape[3] + i3;
            ...
            unsigned int others_idx = o0 * others.shape[1] * others.shape[2] * others.shape[3] + o1 * others.shape[2] * others.shape[3] + o2 * others.shape[3] + o3;
